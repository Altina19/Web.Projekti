...
require_once ('php2/CreateDb-page2.php');
require_once ('./php2/component-page2.php');


// create instance of Createdb class
$database = new CreateDb("Producttb", "Products");
...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'carta-page2.php'</script>";
        }else{
...
<?php require_once ("php2/header-page2.php"); ?>
<div class="container">
