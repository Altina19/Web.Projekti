...
require_once ('php3/CreateDb-page3.php');
require_once ('./php3/component-page3.php');


// create instance of Createdb class
$database = new CreateDb("Productcb", "Users");
...
if (isset($_POST['add'])){
    ...
    if(isset($_SESSION['cart'])){
        ...
        if(in_array($_POST['product_id'], $item_array_id)){
            ...
            echo "<script>window.location = 'index-page3.php'</script>";
        }else{
...
<?php require_once ("php3/header-page3.php"); ?>
<div class="container">
